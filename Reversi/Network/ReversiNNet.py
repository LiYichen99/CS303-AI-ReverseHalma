...
class ReversiNNet(nn.Module):
    def __init__(self, game, args):
        ...
        self.conv2 = nn.Conv2d(args.num_channels, args.num_channels, kernel_size=3, stride=1)
    ...
    def forward(self, s):
        ...
        s = F.relu(self.bn3(self.conv3(s)))                          # batch_size x num_channels x (board_x-2) x (board_y-2)                        # batch_size x num_channels x (board_x-4) x (board_y-4)
